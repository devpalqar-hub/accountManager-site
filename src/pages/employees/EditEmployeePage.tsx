  ...
  const fetchEmployee = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        paidLeavesPerMonth: employee.paidLeavesPerMonth.toString(),
        workingDays: employee.workingDays.split(',').map(Number),
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Update employee details</p>
      </div>
